package Reg_06_ReceberEmbarque;
...
public class CT_ICS_0007 {
	...
	private WebDriver driver;
	  ...
	  public void Précondição() throws Exception {	
		  ...
		  @Test
		  @FileParameters(value = "MassaDados/CT_ICS_0007.csv", mapper = CsvWithHeaderMapper.class)	
		  ...
		  //********************************************************************************************************************************************
		  //	 	Caso de teste - ICS - 0007 - Verificar recebimento do embarque
		  //
